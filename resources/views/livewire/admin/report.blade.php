<div class="p-6 space-y-8">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
            <div class="bg-gradient-to-r from-green-500 to-green-600 rounded-2xl p-6 text-white shadow-lg shadow-green-200">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-green-100 font-bold mb-1">TOTAL UANG MASUK</p>
                        <h2 class="text-4xl font-extrabold">Rp {{ number_format($grandTotal, 0, ',', '.') }}</h2>
                        <p class="text-sm text-green-100 mt-2">Bulan ini</p>
                    </div>
            ...
            <div class="bg-white rounded-2xl p-6 border border-gray-100 shadow-lg shadow-gray-100">
                <div class="flex justify-between items-start">
                    <div>
                        <p class="text-gray-400 font-bold mb-1 uppercase">Total Nota / Bon</p>
                        <h2 class="text-4xl font-extrabold text-gray-800">{{ $totalBon }} <span class="text-lg font-normal text-gray-500">Lembar</span></h2>
                        <p class="text-sm text-gray-400 mt-2">Bulan ini</p>
                    </div>
        ...
        <div id="chartPenjualan" class="w-full h-80"></div>
    </div>
...
<script>
    ...
    // Gunakan Js::from() biar VS Code gak error "Decorators not valid"
    ...
    // Kita tangkap sinyal 'update-chart' dari PHP tadi
    document.addEventListener('livewire:initialized', () => {
        Livewire.on('update-chart', (event) => {
            // event[0] karena kadang Livewire kirim array
            // Sesuaikan dengan data yang dikirim
            renderChart(event.labels, event.data); 
        });
    });
</script>